 ...
 int main()
{
    ...
    printf("\n%s", str); // prints encrypted text to the screen
        ...
        case 4: printf("you have selected option 4\n");  //this runs the substution cipher decryption (same key as above)
            ...
            printf("\n%s\n", str); // prints de-crypted text to the screen
...
//working out and code snippets used to create the assessment
/*
#include <stdio.h>
// the starting user interface, where you select what your going to do
 int main()
...
#include <string.h>
 ...
 /* 
  //questions 1-4 with the user interface, ready for che test (currently at the top of the 'file')
#include <stdio.h>
#include <string.h>
// the starting user interface, where you select what your going to do
 int main()
